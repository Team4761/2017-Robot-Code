...
public class RobotMap {
	...
	public static final int FRONT_LEFT_PDP = 13;
	public static final int BACK_LEFT_PDP = 0;
	public static final int FRONT_RIGHT_PDP = 3;
	public static final int BACK_RIGHT_PDP = 12;
